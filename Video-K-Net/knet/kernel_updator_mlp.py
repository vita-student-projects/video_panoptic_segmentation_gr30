...
class MLP(nn.Module):
    def __init__(self, input_dim, output_dim, bias=True):
        ...
        self.fc2 = nn.Linear(output_dim, output_dim, bias)
        self.relu = nn.ReLU()
...
class KernelUpdatorMLP(nn.Module):
    ...
    def __init__(self,
        ...
        super(KernelUpdatorMLP, self).__init__()
        ...
        self.dynamic_layer = MLP(self.in_channels, self.num_params_in + self.num_params_out)
        self.input_layer = MLP(self.in_channels, self.num_params_in + self.num_params_out, 1)
        self.input_gate = MLP(self.in_channels, self.feat_channels, 1)
        self.update_gate = MLP(self.in_channels, self.feat_channels, 1)
        ...
        self.fc_layer = MLP(self.feat_channels, self.out_channels, 1)
