...
from dataset import get_pretrain_loaders_cityscapes
...
if __name__ == '__main__':
    ...
    train_loader, valid_loader = get_pretrain_loaders_cityscapes()
    ...
    trainer = Trainer(
        model,
        # fn to get loaders
        get_pretrain_loaders_cityscapes,
        # where to save results
        results_folder='./results/pretrain',
        # number of samples
        num_samples=16,
        # training batch size
        train_batch_size=CFG["pretrain"]["batch_size"],
        # gradient accumulation
        gradient_accumulate_every=CFG["pretrain"]["accumulate_every"],
        # learning rate
        train_lr=CFG["pretrain"]["lr"],
